...
function toggleInfoBlock(district) {
  ...
  infoBlock.style.display =
    infoBlock.style.display === "none" ? "block" : "none";
}

//------------------------------------primer grafico---------------------------------------------
axios
  .get(
    "https://api.waqi.info/feed/manhattan/?token=bd1979c8ff6abdfc6029f199bdc2dfa3163903ee"
  )
  .then((response) => {
...
axios
  .get(
    "https://api.waqi.info/feed/brooklyn/?token=bd1979c8ff6abdfc6029f199bdc2dfa3163903ee"
  )
  .then((response) => {
    const datosCalidadAire = response.data.data;
    console.log(datosCalidadAire);
...
axios
  .get(
    "https://api.waqi.info/feed/queens/?token=bd1979c8ff6abdfc6029f199bdc2dfa3163903ee"
  )
  .then((response) => {
    const datosCalidadAire = response.data.data;
    console.log(datosCalidadAire);
...
axios
  .get(
    "https://api.waqi.info/feed/bronx/?token=bd1979c8ff6abdfc6029f199bdc2dfa3163903ee"
  )
  .then((response) => {
    const datosCalidadAire = response.data.data;
    console.log(datosCalidadAire);
...
axios
  .get(
    "https://api.waqi.info/feed/staten island/?token=bd1979c8ff6abdfc6029f199bdc2dfa3163903ee"
  )
  .then((response) => {
    const datosCalidadAire = response.data.data;
    console.log(datosCalidadAire);
...
function searchLocation() {
  ...
  if (location) {
    ...
    alert(
      "No se encontró la ubicación ingresada en los distritos de Nueva York."
    );
  }
}
